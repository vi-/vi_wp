...
/* harmony import */ var _components_gmaps__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/gmaps */ "./src/js/components/gmaps.js");
/* harmony import */ var _components_gmaps__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_gmaps__WEBPACK_IMPORTED_MODULE_5__);
...
_components_gmaps__WEBPACK_IMPORTED_MODULE_5___default().setupGoogleMapsApi(['map'], {
  style: snazzyStyle,
  zoom: 18,
  icon: {
    /* global WP */
...
if (stdSliders) {
  stdSliders.forEach(function (s) {
    var slider = new (flickity__WEBPACK_IMPORTED_MODULE_1___default())(s, {
      cellAlign: 'left',
      wrapAround: true,
      imagesLoaded: true,
      watchCSS: true,
...
var init = function init() {
  ...
  var x = ['one', 'two', 'three'];
  var y = [1, 2, 3];
  console.log([].concat(x, y, ['pooooop']));
};
